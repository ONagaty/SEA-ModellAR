...
public class HostID
{
	...
	private static class DesPrivateEncrypter extends DesDecrypter
	{
		...
		public String encrypt(String str) throws javax.crypto.BadPaddingException, IllegalBlockSizeException,
	...
	static String getFullID()
	{
		...
		String archParam = "a=" + System.getProperty("os.arch") + "n=" + System.getProperty("os.name") + "v="
	...
	/**
	 * Retrieve the HostID. - Linux : based on mac adress - Windows : based on the bios id
	 *
