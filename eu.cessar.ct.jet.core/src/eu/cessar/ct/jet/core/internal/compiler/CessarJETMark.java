 ...
 * 
 * File created by uidu0944 May 25, 2012 9:00:11 AM </copyright>
 */
 ...
 */
public final class CessarJETMark
{
	/**
	...
	class IncludeState
	{
		...
		IncludeState(int inCursor, int inLine, int inCol, int inFileid, String inBaseDir,
	 ...
	 * 
	 * @param reader
	 *        CessarJETReader this mark belongs to
	 * @param inStream
	 *        current stream for this mark
	 * @param fileid
	 *        id of requested jet file
	 * @param inEncoding
	 *        encoding of current file
	 * @param inBaseDir
	 *        base directory of requested jet file
	 */
	CessarJETMark(CessarJETReader reader, char[] inStream, int fileid, String inBaseDir,
		String inEncoding)
	{
		this.reader = reader;
	...
	CessarJETMark(CessarJETMark other)
	{
	...
	public String toDecoratedShortString()
	{
		line++;
		return /*" in JET file " +*/getLocalFile() + "(" + line + "," + col + ")" + "[" + cursor
			+ "," + cursor + "]";
	}
	...
	public String format(String key)
	{
		return CodeGenPlugin.getPlugin().getString(key,
			new Object[] {getLocalFile(), line + 1, col + 1, cursor});
	}

	@Override
	public boolean equals(Object other)
	{
		if (other instanceof CessarJETMark)
		{
			CessarJETMark m = (CessarJETMark) other;
			return this.reader == m.reader && this.fileid == m.fileid && this.cursor == m.cursor
				&& this.line == m.line && this.col == m.col;
		}
		return false;
	}
}
