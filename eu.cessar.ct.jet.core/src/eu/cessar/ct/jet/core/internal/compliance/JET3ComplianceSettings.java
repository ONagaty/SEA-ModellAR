 ...
 * 
 */
public class JET3ComplianceSettings extends AbstractComplianceSettings
{
	...
	// "ecuc.*",//
	// "ecuc.autosar.*",//
	// "org.mosart.armodel.templates.genericstructure.infrastructure.autosar.IContainerDef",//
	};

	/**
	 * 
	 */
	public JET3ComplianceSettings()
	{
