...
import eu.cessar.ct.ecuc.workspace.ui.internal.providers.ExternalStandardModuleDefTableContentProvider;
 ...
 */
public class ExternalStandardModuleDefSelectionPage extends AbstractWizardPage
{
	...
	/** The provider. */
	private ExternalStandardModuleDefTableContentProvider provider;
	...
	/**
	 * Constructor for ExternalStandardModuleDefinitionSelectionPage.
	 * 
	 */
	public ExternalStandardModuleDefSelectionPage()
	{
		super("ExternalStandardModuleDefinitionSelectionPage"); //$NON-NLS-1$
	}
	 ...
	 *        the selection
	 */
	public ExternalStandardModuleDefSelectionPage(IStructuredSelection selection)
	{
		this();
	...
	protected void doCreateControl(Composite parent)
	{
		...
		provider = new ExternalStandardModuleDefTableContentProvider(project);
	...
	protected void handleModuleSelection(IStructuredSelection currentSelection)
	{
		...
		{
			currentObject = (GModuleDef) currentSelection.getFirstElement();
			setSelectedModuleDefinition((GModuleDef) currentObject);
		}
		else
		{
	...
	public String getErrorMessage()
	{
		...
		{
			return Messages.ExternalStandardModuleDefinitionSelectionPage_Err_No_ModuleDefinition;
		}
	...
	public void setExternalStandardImportFilePath(String externalStandardImportFilePath)
	{
		...
		provider.setExternalStandardImportFilePath(externalStandardImportFilePath);
		provider.setProject(getProject());
	}
}
