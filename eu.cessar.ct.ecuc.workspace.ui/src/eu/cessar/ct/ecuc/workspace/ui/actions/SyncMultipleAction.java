 ...
 * 
 * File created by aurel_avramescu Aug 17, 2010 5:08:20 PM </copyright>
 */
...
import eu.cessar.ct.ecuc.workspace.cleanup.ModuleConfigurationSynchronizer;
 ...
 * 
 */
public class SyncMultipleAction extends AbstractSyncCleanAction
{
					...
					new Runnable()
					{
						public void run()
						{
							try
							{
								...
								{
									ModuleConfigurationSynchronizer cleaner = new ModuleConfigurationSynchronizer(
