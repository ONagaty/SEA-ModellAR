...
public class BreadcrumbItem extends Item
{
	...
	protected final BreadcrumbItemDetail itemDetail;
	protected final BreadcrumbItemExpand itemArrow;
	 ...
	 *        the isDropdownOpen to set
	 */
	public void setDropdownOpen(boolean isDropdownOpen)
	{
		this.isDropdownOpen = isDropdownOpen;
	}

	/* fragment (breadcrumb element) - i.e My PC\d:\WorkingTasks\Prj: WorkingTasks is a fragment, etc */
	...
	public BreadcrumbItem(final BreadcrumbViewer viewer, final Composite parent)
	{
		...
		itemArrow = viewer.createBreadcrumbItemExpand(this, container);
	 ...
	 */
	public BreadcrumbItemDetail getItemDetail()
	{
		return itemDetail;
	}
	 ...
	 */
	BreadcrumbItemExpand getItemDropDown()
	{
		return itemArrow;
	}
	...
	public void refresh()
	{
		final String text = labelProvider.getText(fragment);
		final Image image = labelProvider.getImage(fragment);
		String toolTip = text;
		if (toolTipLabelProvider instanceof CellLabelProvider)
		{
			...
			toolTip = provider.getToolTipText(fragment);
		}
	...
	/**
	 * Refresh the arrows visibility - type checking for ITreeContentProvider,
	 * instead of sub-classing the BreadcrumbItem..
	 */
	void refreshArrow()
	{
		if (contentProvider instanceof ITreeContentProvider)
		{
			final boolean hasChildren = ((ITreeContentProvider) contentProvider).hasChildren(fragment);
	 ...
	 * 
	 * @param selected
	 *        <code>true</code> if this element is selected, <code>false</code>
	 *        otherwise.
	 */
