 ...
 * 
 */
public class SingleBigIntegerEditor extends AbstractSingleNumericalEditor<BigInteger>
{
	/**
	 ...
	 */
	public SingleBigIntegerEditor(boolean acceptNull)
	{
		super(acceptNull);
	}
	 ...
	 */
	public SingleBigIntegerEditor(boolean acceptNull, ERadix radix)
	{
		this(acceptNull);
		this.radix = radix;
	}
