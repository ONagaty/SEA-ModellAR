...
import eu.cessar.ct.core.platform.ui.widgets.SinglePositiveBigIntegerEditor;
 ...
 *
 */
public class SinglePositiveUnlimitedIntegerEditorPart extends AbstractSingleNumericDatatypeEditorPart<BigInteger>
	implements IIntegerEditorPart
{
	private SinglePositiveBigIntegerEditor editor;

	/**
	 * @param editor
	 */
	public SinglePositiveUnlimitedIntegerEditorPart(IModelFragmentFeatureEditor editor)
	{
		super(editor);
	}
 ...
 */
	...
	protected IDatatypeEditor<BigInteger> createDatatypeEditor()
	{
		...
		editor = new SinglePositiveBigIntegerEditor(true);
		return editor;
	}
