 ...
 * 
 */
public class JavaMainTaskManager extends AbstractJobBasedTaskManager<String>
{
	 ...
	 * @param project
	 */
	public JavaMainTaskManager(ICessarTaskDescriptor descriptor, IProject project)
	{
	...
	protected List<CessarTask<String>> createCessarTask(String input, Object parameter)
	{
		...
		result.add(new JavaMainClassTask(this, input, input, getExecutionLoader().getClassLoader(),
