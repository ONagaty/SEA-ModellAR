 ...
 *
 */
public class DescriptionAttributeSortCriterion extends SimpleAttributeSortCriterion
{
	 ...
	 * @param attribute
	 */
	public DescriptionAttributeSortCriterion(ISortTarget sortTarget)
	{
	...
	public Object getObjectToCompare(EObject parent)
	{
		...
		{
			return IdentifiableUtil.getDesc(parent, "EN");
		}
		return null;
	}
