...
import eu.cessar.ct.compat.internal.pmproxy.wrap.GForeignReferenceDef_ShortnameCompatFeatureWrapper;
 ...
 */
public class GForeignReferenceDef_ShortnameCompatFeatureResolver extends
	AbstractEAttributeFeatureResolver<Object>
{
		...
		EMFProxyObjectImpl proxyObject, EAttribute attribute)
	{
		...
		return new GForeignReferenceDef_ShortnameCompatFeatureWrapper(engine, refValue);
	}
