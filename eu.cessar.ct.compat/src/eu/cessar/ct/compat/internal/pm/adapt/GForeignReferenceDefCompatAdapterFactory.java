 ...
 * 
 */
public class GForeignReferenceDefCompatAdapterFactory implements IEMFAdapterFactory
{
		...
		Object target, Class<?> type)
	{
		if (target instanceof GForeignReferenceDef)
		{
			...
			{
				GForeignReferenceDefCompatPMInfo result = new GForeignReferenceDefCompatPMInfo();
				return result;
			}
		}
		return null;
