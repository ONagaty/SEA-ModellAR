 ...
 * 
 */
public class GChoiceContainerDefCompatAdapterFactory implements IEMFAdapterFactory
{
		...
		Object target, Class<?> type)
	{
		if (target instanceof GChoiceContainerDef)
		{
			...
			{
				GChoiceContainerDefCompatPMInfo result = new GChoiceContainerDefCompatPMInfo();
				return result;
			}
		}
		return null;
