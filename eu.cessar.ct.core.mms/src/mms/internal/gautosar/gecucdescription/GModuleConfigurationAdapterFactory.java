 ...
 * implementations for GModuleConfiguration.
 */
public class GModuleConfigurationAdapterFactory extends AbstractEMFAdapterFactory
{
	/* (non-Javadoc)
		...
		Object target, Class<?> type)
	{
		if (IEditingDomainItemProvider.class.equals(type))
		{
			...
			{
				return new GModuleConfigurationEditingDomainItemProvider(
