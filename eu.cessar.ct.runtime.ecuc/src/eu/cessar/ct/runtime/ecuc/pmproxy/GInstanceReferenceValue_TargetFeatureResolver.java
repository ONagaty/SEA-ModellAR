 ...
 * 
 * File created by uidl6458 Feb 4, 2010 7:44:36 PM </copyright>
 */
...
import eu.cessar.ct.runtime.ecuc.pmproxy.wrap.GInstanceReferenceTargetFeatureWrapper;
import gautosar.gecucdescription.GInstanceReferenceValue;

/**
 * 
 */
public class GInstanceReferenceValue_TargetFeatureResolver extends
	AbstractEReferenceFeatureResolver
{
		...
		EMFProxyObjectImpl proxyObject, EReference reference)
	{
		...
		return new GInstanceReferenceTargetFeatureWrapper(engine, iRefValue);
	}
